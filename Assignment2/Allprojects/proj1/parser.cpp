...
void Parser::parseNffFile(Camera *cam) {
	string line, token;
	//file name
	ifstream myfile("assets/teste.nff");

	//ifstream myfile("assets/balls_low.nff");
	//ifstream myfile("assets/balls_medium.nff");
	//ifstream myfile("assets/balls_high.nff");
	...
	if (myfile.is_open())
	{
		while (getline(myfile, line))
		{
			...
			else if (token == "l")
			{
				...
				Light *light = new LightArea(aux_pos, aux_color);
